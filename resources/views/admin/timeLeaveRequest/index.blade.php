                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xxl col-xl-4 mt-3">
                                <div class="d-flex float-end">
                                    ...
                                    <a class="btn btn-block btn-primary" href="{{route('admin.time-leave-request.index')}}">{{ __('index.reset') }}</a>
                                </div>
                            </div>
                        </div>
                    </form>
                                    ...
                                    <tr>
                                        ...
                                        @can('show_leave_request_detail')
                                            <td class="text-center">
                                                <a href="#" class="showTimeLeaveReason" data-href="{{ route('admin.time-leave-request.show', $value->id) }}" title="{{ __('index.show_leave_reason') }}">
